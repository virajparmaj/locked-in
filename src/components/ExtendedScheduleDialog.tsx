    ...
    <Dialog open={open} onOpenChange={(o) => { if (!o) onCancel() }}>
      ...
      <div className="rounded-lg border bg-card p-4 space-y-4">
        <div className="space-y-2">
          ...
          <Select id="ext-month" value={String(safeMonth)} onValueChange={(v) => setMonthOfYear(Number(v))}>
        ...
        <div className="rounded-md bg-muted/50 px-3 py-2 border">
          <p className="text-[11px] text-muted-foreground uppercase tracking-wide font-medium mb-1">Preview</p>
      ...
      <div className="flex gap-2 justify-end pt-4">
        ...
        <Button type="button" onClick={handleSave}>Apply</Button>
      </div>
    </Dialog>
  )
}
